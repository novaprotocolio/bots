...
func getTestClient(t *testing.T) *NovaClient {
...
func TestNovaClient_CreateOrder(t *testing.T) {
...
func TestNovaClient_CancelOrder(t *testing.T) {
	client := getTestClient(t)
...
func TestNovaClient_GetOrder(t *testing.T) {
	client := getTestClient(t)
...
func TestNovaClient_GetAllPendingOrders(t *testing.T) {
	client := getTestClient(t)
...
func TestNovaClient_CancelAllPendingOrders(t *testing.T) {
	client := getTestClient(t)
